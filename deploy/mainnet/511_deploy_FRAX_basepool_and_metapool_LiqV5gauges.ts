...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    const newGaugeArr = [
        ...
        { lpToken: "SaddleFRAXsUSDMetaPoolLPToken", gaugeType: 0, initialWeight: 0 },
        { lpToken: "SaddleFRAXUSDTMetaPoolLPToken", gaugeType: 0, initialWeight: 0 },
        { lpToken: "SaddleFRAXalUSDMetaPoolLPToken", gaugeType: 0, initialWeight: 0 },
    ]
